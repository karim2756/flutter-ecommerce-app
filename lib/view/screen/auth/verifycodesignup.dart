...
import 'package:my_project/controller/auth/VerifyCodeSignUp_controller.dart';
...
class VerifyCodeSignUp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    VerifyCodeControllerSignUpImp controller = Get.put(VerifyCodeControllerSignUpImp());
    return Scaffold(
      appBar: AppBar(
